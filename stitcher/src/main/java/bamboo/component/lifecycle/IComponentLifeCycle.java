...
public interface IComponentLifeCycle extends ComponentCallbacks2 {
     ...
     *
     * @param routerRegistry         数据路由注册表
     * @param activityRouterRegistry 页面路由注册表
     */
    void onCreateDelay(ComponentRouterRegistry routerRegistry, ActivityRouterRegistry activityRouterRegistry);
